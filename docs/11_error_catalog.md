...
| 트리거 | 노출 메시지 |
|---|---|
| R-번호 미입력 | "접수 번호를 입력해 주세요." |
| R-번호 매칭 실패 | "해당 번호의 신고를 찾을 수 없어요." |
| (사안 상세) reports 에 없음 | "해당 번호의 사안을 찾을 수 없어요." |
| 사안 삭제 성공 | "사안이 삭제되었어요." (스낵바) |
...
| 알림 인박스 | "아직 알림이 없어요." / "신고나 사안 진행이 있을 때 여기에 알려드릴게요." |
| 보호자 자녀 카드 (없음) | "아직 진행 중인 사안이 없어요" / "신고하기로 시작해 보세요." |
| 교사 사안 리스트 (없음) | "아직 접수된 사안이 없어요." / "신고가 들어오면 여기에 나타납니다." |
